...
export function CtaBand({
  ...
  body = "Send the service, artwork and date. We will reply with scope, price and timing.",
}: {
  title?: string;
  body?: string;
}) {
    ...
    <section className="bg-blue text-card">
      <Container className="flex flex-col items-start justify-between gap-8 py-16 lg:flex-row lg:items-end">
        <div className="max-w-2xl">
          <p className="text-[0.75rem] font-semibold uppercase tracking-[0.16em] text-copper">Next step</p>

...
export function ProcessStrip() {
  return (
    <section className="border-b border-line bg-[linear-gradient(180deg,#fbf6ee_0%,#efe4d0_100%)] py-16 sm:py-24">
      <Container>
        ...
        <ol className="mt-12 grid gap-4 md:grid-cols-4">
          {processSteps.map((step) => (
            <li key={step.n} className="border border-line bg-ivory/80 p-6">

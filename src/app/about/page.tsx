...
export const metadata = pageMetadata({
  title: "About Brandstitch Works",
  description:
    "Brandstitch Works is a Pakistan-based embroidery digitizing and custom products studio serving businesses and organizations in the US, UK, Australia and worldwide.",
  path: "/about",
});
...
export default function Page() {
  return (
    <>
      <PageHero
        eyebrow="About"
        title="Digitizing and custom branded products for shops, brands and teams."
        lede={site.location}
      />
        ...
        <Container className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <div className="prose-site mt-4 leading-7 text-ink-soft">
              <p>
                {site.name} does two kinds of work. The first is artwork: turning a logo into an embroidery file that sews cleanly, redrawing a low-quality logo as
                vector paths, or designing a new mark. The second is finished products: custom patches, embroidered apparel, screen-printed shirts and caps,
            ...
            <p className="mt-4 leading-7 text-ink-soft">
              ...
              quote shipping to your postal code for every product order. We do not operate offices or warehouses outside {site.address.country}, and we do not
              claim US manufacturing or US employees.
            </p>
            <h2 className="mt-10 text-2xl font-semibold">Serving US buyers</h2>
            <div className="prose-site mt-4 leading-7 text-ink-soft">
              <p>
                Quotes for US customers are prepared in USD when that is the currency on your written quotation. Support hours and timezone appear on Contact when
                published. For physical orders, production time and transit time are listed separately. Import duties, taxes and broker fees are the buyer&apos;s
                responsibility unless your quote states otherwise. Destination restrictions, including Alaska, Hawaii and US territories, are confirmed on the
                quote when they affect shipping.
              </p>
            </div>
          </div>
